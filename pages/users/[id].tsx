...
import { ArrowLeft, Crown, TrendingUp, TrendingDown, Shield, Trash2 } from 'lucide-react'
      ...
      <div className="flex flex-col gap-8 max-w-3xl">
        ...
        <div className="flex items-start gap-5 flex-wrap">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-slate-600 text-xs mt-1">Cadastrado em {new Date(user.createdAt).toLocaleDateString('pt-BR')}{user.whatsappPhone && ` · WhatsApp: ${user.whatsappPhone}`}</p>
          </div>
        </div>
